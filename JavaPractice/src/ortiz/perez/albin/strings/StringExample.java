...
public class StringExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(new A());// the toString() method is invoked when
									// objects are used in print, println and
									// concatenation expressions
		System.out.println("toString() " + new A());// concatenation expression

		for (Byte x : u.getBytes())// get array of bytes from the characters of
			System.out.print(x);// the string object
		
		System.out.println(u.toCharArray());//prints the array of chars of the String object
	}
