...
public class ResourceBundleExample {
	...
	ResourceBundle resourceBundle = ResourceBundle
			.getBundle("practice.java.resourcebundle.global", Locale.forLanguageTag("en"));

	ResourceBundle resourceBundle1 = ResourceBundle
			.getBundle("practice.java.resourcebundle.global", Locale.forLanguageTag("sp"));
