...
@XmlRootElement(name = "ParameterType", namespace = "http://xmlns.tigo.com/ParameterType/V2")
public class ParameterType {

    @XmlElement(namespace = "http://xmlns.tigo.com/ParameterType/V2", required = true)
